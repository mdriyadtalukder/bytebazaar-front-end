...
const Asus = () => {
    ...
    const asus = [
        ...
        },
        {
            ...
            name: 'Laptop Series',
            options: [
                { value: 'expertbook', label: 'ExpertBook', checked: false },
                { value: 'p-series', label: 'P Series', checked: false },
    ...
    return (
        <AllCategory data={data?.filter(d => d?.productGeneral?.productBrand === "Asus")} isError={isError} isLoading={isLoading} error={error} filtering={asus}  ></AllCategory>
