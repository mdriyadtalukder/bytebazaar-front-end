...
import { useAddLaptopMutation } from "../../../../../RTK-Query/features/allProduct/allProductApi";
  ...
  const handleCreating = async (e) => {
    ...
    addLaptop({
      ...
      productGeneral: {
        productBrand: brand,
        productModel: model,
        productLaptopSeries: series,
        productPartNo: part
      },
      productProcessor: {
        processorBrand: pBrand,
        processorType: pType,
        processorGeneration: generation,
        processorModel: pModel,
        processorCore: pCore,
        performanceCores: performance,
        efficientCores: effeciantCores
      },
      productMemory: {
        ram: ram,
        installedRAMDetails: installedRAMDetails,
        ramType: ramType,
        totalRAMSlot: totalRAMSlot,
        emptyExpansionRAMSlot: emptyExpansionRAMSlot,
      ...
      productStorage: {
        ...
        hddRPM: hddRPM,
        hddExpansionSlot: hddExpansionSlot,
        installedSSDType: installedSSDType,
        m2ssdExpansionSlot: m2ssdExpansionSlot,
        storageUpgrade: storageUpgrade
      },
      productGraphics: {
        graphicsChipset: graphicsChipset,
        graphicsMemoryAccessibility: graphicsMemoryAccessibility,
        graphicsMemory: graphicsMemory,
        graphicsMemoryType: graphicsMemoryType
      },
      productDisplay: {
        ...
        displayBezel: displayBezel,
        brightness: brightness,
        displayFeatures: displayFeatures,
        secondaryScreenSize: secondaryScreenSize,
        secondaryScreenTechnology: secondaryScreenTechnology,
        secondaryScreenResolution: secondaryScreenResolution
      },
      productPortsSlots: {
        opticalDrive: opticalDrive,
        multimediaCardSlot: multimediaCardSlot,
        supportedMultimediaCard: supportedMultimediaCard,
        usb2Port: usb2Port,
        usb3Port: usb3Port,
        usbCThunderboltPort: usbCThunderboltPort,
        hdmiPort: hdmiPort,
        microHdmiPort: microHdmiPort,
        miniHdmiPort: miniHdmiPort,
        displayPort: displayPort,
        miniDPPort: miniDPPort,
        vgaDSub: vgaDSub,
        headphonePort: headphonePort,
        microphonePort: microphonePort,
        securityLockSlot: securityLockSlot
      },
      ...
      productAudioCamera: {
        audioProperties: audioPropertiesValue,
        speaker: speakerValue,
        microphone: microphoneValue,
        webCam: webCamValue
      },
      productKeyboard: {
        keyboardLayout: keyboardLayoutValue,
        keyboardBacklit: keyboardBacklitValue,
        rgbKeyboard: rgbKeyboardValue,
        numKeypad: numKeypadValue,
        pointingDevice: pointingDeviceValue
      },
      productSecurity: {
        fingerPrintSensor: fingerPrintSensorValue
      },
      productSoftware: {
        operatingSystem: operatingSystemValue,
        licensedApplication: licensedApplicationValue
      },
      productPhysicalDescription: {
        color: colorValue,
        dimensions: dimensionsValue,
        weightKg: weightKgValue,
        packageContent: packageContentValue
      },
      productPower: {
        batteryCapacity: batteryCapacityValue,
        batteryType: batteryTypeValue,
        backupTime: backupTimeValue,
        powerAdapter: powerAdapterValue,
        adapterType: adapterTypeValue
      },
      productWarranty: {
        warranty: warrantyValue,
        warrantyDetails: warrantyDetailsValue,
        warrantyClaimDurationApproximate: warrantyClaimDurationApproximateValue
      },
      productAdditionalInfo: {
        ...
        madeInAssemble: madeInAssembleValue,
                ...
                <div className="-mx-3 flex flex-wrap">
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="brand" id="name" placeholder="Enter band"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      <label htmlFor="model" className="mb-3 block text-base font-medium text-[#07074D]">
                        Product Model                  </label>
                      <input type="text" name="model" id="name" placeholder="Enter model"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="series" id="name" placeholder="Enter laptop series"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="part" id="name" placeholder="Enter port no"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                ...
                <div className="-mx-3 flex flex-wrap">
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="processorBrand" id="processorBrand" placeholder="Enter brand"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="processorType" id="processorType" placeholder="Enter type"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="processorGeneration" id="processorGeneration" placeholder="Enter generation"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="processorModel" id="processorModel" placeholder="Enter model"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="processorCore" id="processorCore" placeholder="Enter core count"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="performanceCores" id="performanceCores" placeholder="Enter performance cores"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="efficientCores" id="efficientCores" placeholder="Enter efficient cores"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                </div>
                ...
                <div className="-mx-3 flex flex-wrap">
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="ram" id="ram" placeholder="Enter RAM size"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="installedRAMDetails" id="installedRAMDetails" placeholder="Enter installed RAM details"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="ramType" id="ramType" placeholder="Enter RAM type"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="totalRAMSlot" id="totalRAMSlot" placeholder="Enter total RAM slots"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="emptyExpansionRAMSlot" id="emptyExpansionRAMSlot" placeholder="Enter empty expansion RAM slot availability"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="maxRAMSupport" id="maxRAMSupport" placeholder="Enter max RAM support"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                </div>
                ...
                <div className="-mx-3 flex flex-wrap">
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="storage" id="storage" placeholder="Enter storage details"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="installedHDDType" id="installedHDDType" placeholder="Enter installed HDD type"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="hddRPM" id="hddRPM" placeholder="Enter HDD RPM"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="hddExpansionSlot" id="hddExpansionSlot" placeholder="Enter HDD expansion slot details"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="installedSSDType" id="installedSSDType" placeholder="Enter installed SSD type"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="m2ssdExpansionSlot" id="m2ssdExpansionSlot" placeholder="Enter M.2 SSD expansion slot details"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="storageUpgrade" id="storageUpgrade" placeholder="Enter storage upgrade details"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                </div>
                ...
                <div className="-mx-3 flex flex-wrap">
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="graphicsChipset" id="graphicsChipset" placeholder="Enter graphics chipset"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="graphicsMemoryAccessibility" id="graphicsMemoryAccessibility" placeholder="Enter graphics memory accessibility"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="graphicsMemory" id="graphicsMemory" placeholder="Enter graphics memory"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="graphicsMemoryType" id="graphicsMemoryType" placeholder="Enter graphics memory type"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                </div>
                ...
                <div className="-mx-3 flex flex-wrap">
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="number" name="displaySizeInch" id="displaySizeInch" placeholder="Enter display size"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="displayType" id="displayType" placeholder="Enter display type"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="panelType" id="panelType" placeholder="Enter panel type"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="displayResolution" id="displayResolution" placeholder="Enter display resolution"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="displaySurface" id="displaySurface" placeholder="Enter display surface"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="touchScreen" id="touchScreen" placeholder="Enter touch screen availability"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="displayRefreshRate" id="displayRefreshRate" placeholder="Enter display refresh rate"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="displayBezel" id="displayBezel" placeholder="Enter display bezel type"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="brightness" id="brightness" placeholder="Enter display brightness"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3">
                    <div className="mb-5">
                      ...
                      <textarea name="displayFeatures" id="displayFeatures" rows="3" placeholder="Enter display features"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] resize-none outline-none focus:border-[#6A64F1] focus:shadow-md"></textarea>
                    </div>
                  </div>
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="secondaryScreenSize" id="secondaryScreenSize" placeholder="Enter secondary screen size"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="secondaryScreenTechnology" id="secondaryScreenTechnology" placeholder="Enter secondary screen technology"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="secondaryScreenResolution" id="secondaryScreenResolution" placeholder="Enter secondary screen resolution"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                </div>
                ...
                <div className="-mx-3 flex flex-wrap">
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="opticalDrive" id="opticalDrive" placeholder="Enter optical drive availability"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="multimediaCardSlot" id="multimediaCardSlot" placeholder="Enter multimedia card slot availability"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="supportedMultimediaCard" id="supportedMultimediaCard" placeholder="Enter supported multimedia card"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="usb2Port" id="usb2Port" placeholder="Enter USB 2.0 port availability"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="usb3Port" id="usb3Port" placeholder="Enter USB 3.0 port availability"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="usbCThunderboltPort" id="usbCThunderboltPort" placeholder="Enter USB-C Thunderbolt port details"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="hdmiPort" id="hdmiPort" placeholder="Enter HDMI port availability"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="microHdmiPort" id="microHdmiPort" placeholder="Enter micro HDMI port availability"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="miniHdmiPort" id="miniHdmiPort" placeholder="Enter mini HDMI port availability"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="displayPort" id="displayPort" placeholder="Enter display port availability"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      <label htmlFor="miniDPPort" className="mb-3 block text-base font-medium text-[#07074D]">
                        Mini DisplayPort
                      </label>
                      <input type="text" name="miniDPPort" id="miniDPPort" placeholder="Enter mini DisplayPort availability"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="vgaDSub" id="vgaDSub" placeholder="Enter VGA D-Sub port availability"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="headphonePort" id="headphonePort" placeholder="Enter headphone port type"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="microphonePort" id="microphonePort" placeholder="Enter microphone port type"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="securityLockSlot" id="securityLockSlot" placeholder="Enter security lock slot availability"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                </div>
                ...
                <div className="-mx-3 flex flex-wrap">
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="lan" id="lan" placeholder="Enter LAN availability"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="wiFi" id="wiFi" placeholder="Enter Wi-Fi availability"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="bluetooth" id="bluetooth" placeholder="Enter Bluetooth version"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                </div>
                ...
                <div className="-mx-3 flex flex-wrap">
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="audioProperties" id="audioProperties" placeholder="Enter audio properties"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="speaker" id="speaker" placeholder="Enter speaker availability"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="microphone" id="microphone" placeholder="Enter microphone availability"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="webCam" id="webCam" placeholder="Enter webcam details"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                </div>
                ...
                <div className="-mx-3 flex flex-wrap">
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="keyboardLayout" id="keyboardLayout" placeholder="Enter keyboard layout details"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="keyboardBacklit" id="keyboardBacklit" placeholder="Enter keyboard backlit availability"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="rgbKeyboard" id="rgbKeyboard" placeholder="Enter RGB keyboard availability"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="numKeypad" id="numKeypad" placeholder="Enter numeric keypad availability"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="pointingDevice" id="pointingDevice" placeholder="Enter pointing device details"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                </div>
                ...
                <div className="-mx-3 flex flex-wrap">
                  <div className="w-full px-3 sm:w-full">
                    <div className="mb-5">
                      ...
                      <input type="text" name="fingerPrintSensor" id="fingerPrintSensor" placeholder="Enter fingerprint sensor availability"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                </div>
                ...
                <div className="-mx-3 flex flex-wrap">
                  <div className="w-full px-3 sm:w-1/2">
                    <div className="mb-5">
                      ...
                      <input type="text" name="operatingSystem" id="operatingSystem" placeholder="Enter operating system"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3 sm:w-1/2">
                    <div className="mb-5">
                      ...
                      <input type="text" name="licensedApplication" id="licensedApplication" placeholder="Enter licensed application availability"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                </div>
                ...
                <div className="-mx-3 flex flex-wrap">
                  ...
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="dimensions" id="dimensions" placeholder="Enter product dimensions"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="weightKg" id="weightKg" placeholder="Enter product weight in kg"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="packageContent" id="packageContent" placeholder="Enter package content details"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                </div>
                ...
                <div className="-mx-3 flex flex-wrap">
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="batteryCapacity" id="batteryCapacity" placeholder="Enter battery capacity"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="batteryType" id="batteryType" placeholder="Enter battery type"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="backupTime" id="backupTime" placeholder="Enter backup time"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="powerAdapter" id="powerAdapter" placeholder="Enter power adapter details"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="adapterType" id="adapterType" placeholder="Enter adapter type"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                </div>
                ...
                <div className="-mx-3 flex flex-wrap">
                  <div className="w-full px-3 sm:w-1/3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="warranty" id="warranty" placeholder="Enter warranty period"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="warrantyDetails" id="warrantyDetails" placeholder="Enter warranty details"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="warrantyClaimDurationApproximate" id="warrantyClaimDurationApproximate" placeholder="Enter warranty claim duration"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                </div>
                ...
                <div className="-mx-3 flex flex-wrap">
                  <div className="w-full px-3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="certifications" id="certifications" placeholder="Enter certifications"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="bestFor" id="bestFor" placeholder="Enter best for"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="specialty" id="specialty" placeholder="Enter specialty"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="others" id="others" placeholder="Enter other details"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="countryOfOrigin" id="countryOfOrigin" placeholder="Enter country of origin"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="madeInAssemble" id="madeInAssemble" placeholder="Enter made in assemble details"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                  <div className="w-full px-3">
                    <div className="mb-5">
                      ...
                      <input type="text" name="disclaimer" id="disclaimer" placeholder="Enter disclaimer"
                        className="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                  </div>
                </div>
