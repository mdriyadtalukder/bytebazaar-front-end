...
import img3 from '../../../assets/laptop-names/samsung.jpg';
...
import img11 from '../../../assets/laptop-names/razer-blade-15-ch9-unibody-desktop.png';
            ...
            >
                ...
                <SwiperSlide className='h-[350px] w-[300px]  border-2 rounded-lg flex justify-center items-center border-indigo-400   ' >
                    <div>
                        ...
                        <p className='text-2xl -mt-16 text-indigo-400 text-center font-bold uppercase'>samsung</p>
                    </div>
                </SwiperSlide>
                <SwiperSlide className='h-[350px] w-[300px]  border-2 rounded-lg flex justify-center items-center border-indigo-400   ' >
                    <div>
                ...
                <SwiperSlide className='h-[350px] w-[300px]  border-2 rounded-lg  flex justify-center items-center border-indigo-400  ' >
                    <div>
                        ...
                        <p className='text-2xl -mt-16 text-indigo-400 text-center font-bold uppercase'>razer</p>
                    </div>
